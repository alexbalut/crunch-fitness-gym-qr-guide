...
```bash
git clone https://github.com/alexbalut/crunch-fitness-gym-qr-guide.git
...
Credentials: `admin@crunch-fitness.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Crunch Fitness Lachine with 10 machines and sample issues/views.
