...
async function main() {
  console.log("Seeding Crunch Fitness Lachine...");
  ...
  console.log("   Gym: Crunch Fitness Lachine");
  console.log("   Login: admin@crunch-fitness.demo / demo1234");
